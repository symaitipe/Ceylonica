                    ...
                    <div className="form-group">
                      ...
                      >
                        {newProduct.cardImage ? (
                          <img
                            src={URL.createObjectURL(newProduct.cardImage)}
                            alt="Card preview"
                            style={{
                              width: "100%",
                              height: "100%",
                          ...
                          return (
                            <div key={index}>
                              <input
                                ...
                                accept="image/*"
                                ref={(el) =>
                                  (detailImagesInputRef.current[index] = el)
                                }
                                style={{ display: "none" }}
                                onChange={(e) => {
                                  if (e.target.files[0]) {
                                    const newDetails = [
                                      ...newProduct.detailImages,
                                    ];
                                    newDetails[index] = e.target.files[0];
                                    setNewProduct({
                                      ...newProduct,
                                      detailImages: newDetails,
                                    });
                                  }
                                }}
                              />
                              <div
                                className="image-upload-box"
                                onClick={() =>
                                  detailImagesInputRef.current[index] &&
                                  detailImagesInputRef.current[index].click()
                                }
                                style={{
                                  overflow: "hidden",
                                  position: "relative",
